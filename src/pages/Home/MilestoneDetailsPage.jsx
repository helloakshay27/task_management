      ...
      <div className="m-4">
        ...
        <div className="px-4 pt-1">
            ...
            <div className="mt-3" ref={secondContentRef}>
              <div className="flex flex-col">
                <div className="w-1/2 flex items-center justify-start gap-3 ml-36">
                  ...
                  <div className="text-left text-[12px]">{milestone.owner_name}</div>
                </div>
                ...
                <div className="w-1/2 flex items-center justify-start gap-3 ml-36">
                  ...
                  <div className="text-left text-[12px]">{milestone?.end_date?.split('T')[0]}</div>
                </div>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="border-b-[3px] border-[rgba(190, 190, 190, 1)]"></div>
            <div>{tab === 'Dependancy' && <MilestoneDependancyTable />}</div>
          </div>
        </div>
      </div>
      {isEditModalOpen && (
