...
const Comments = ({ comments, getIssue }) => {
  ...
  const handleEditSave = async () => {
    ...
    await dispatch(editTaskComment({ token, id: editingCommentId, payload: formData })).unwrap();
    getIssue();
  };
    ...
    <div className="m-4">
      <div className="px-4 pt-1">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center ml-36">
                <div className="w-1/2 flex items-center justify-start gap-3">
                  ...
                  <div className="text-left text-[12px]">
                    {issueDetails?.start_date.split('T')[0]}
                  </div>
                </div>
                <div className="w-1/2 flex items-center justify-start gap-3">
              ...
              <div className="flex items-center ml-36">
                <div className="w-1/2 flex items-center justify-start gap-3">
                  ...
                  <div className="text-left text-[12px]">
                    {issueDetails?.end_date.split('T')[0]}
                  </div>
                </div>
                <div className="w-1/2 flex items-center justify-start gap-3">
                  <div className="text-right text-[12px] font-[500]">Project :</div>
                  <div className="text-left text-[12px]">
                    {issueDetails?.project_management_name || ''}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div>
            {tab == 'Documents' && (
              <Attachments attachments={issueDetails?.attachments} id={issueDetails?.id} />
            )}
            {tab == 'Comments' && (
              <Comments comments={issueDetails?.comments} getIssue={getIssue} />
            )}
          </div>
        </div>
      </div>
