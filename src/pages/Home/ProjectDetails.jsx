    ...
    <div className="m-4">
      ...
      <div className="px-4 pt-1">
            ...
            <div className="flex flex-col">
              <div className="flex items-center ml-36">
                <div className="w-1/2 flex items-center justify-start gap-3">
                  <div className="text-right text-[12px] font-[500]">Project Manager :</div>
              ...
              <div className="flex items-center ml-36">
                <div className="w-1/2 flex items-center justify-start gap-3">
                  <div className="text-right text-[12px] font-[500]">Project Type:</div>
              ...
              <div className="flex items-center ml-36">
                ...
                <div className="w-1/2 flex items-center justify-start gap-3">
                  <div className="text-right text-[12px] font-[500]">Issues :</div>
        ...
        <div>
          ...
          <div>
            {tab == 'Member' && (
              <Members allNames={projectMembers} projectOwner={project.project_owner_name} />
            )}
            {tab == 'Documents' && (
