        ...
        <div className="px-4 pt-1">
          ...
          <div className="flex items-center justify-between my-3 text-[12px]">
            <div className="flex items-center gap-3 text-[#323232]">
              ...
              <span className="h-6 w-[1px] border border-gray-300"></span>
              <span
                className={`flex relative items-center gap-2 cursor-pointer px-2 py-1 rounded-md text-sm ${STATUS_COLORS[mapDisplayToApiStatus(selectedOption).toLowerCase()] || 'bg-gray-400 text-white'}`}
              >
              ...
              <span className="cursor-pointer flex items-center gap-1">
                <ActiveTimer
                  activeTimeTillNow={task.active_time_till_now}
                  isStarted={task.is_started}
                />
              </span>
              <span className="h-6 w-[1px] border border-gray-300"></span>
              <span className="cursor-pointer flex items-center gap-1" onClick={handleAddToDo}>
              ...
              >
                <PencilIcon className="mx-1" size={15} />{' '}
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center ml-36">
                  ...
                  <div className="w-1/2 flex items-center justify-start gap-3">
                    ...
                    <div className="text-left text-[12px]">
                      {task.parent_id ? task.parent_task_title : task.milestone?.title}
                    </div>
                  </div>
                </div>
                <span className="border h-[1px] inline-block w-full my-4"></span>
                          ...
                          {task.observers?.map((observer) => (
                            <Tooltip key={observer.id}>
                              <TooltipTrigger asChild>
                                <div className="border-2 border-[#c72030] bg-[#c72030]/10 text-[#c72030] rounded-full w-8 h-8 flex items-center justify-center text-xs font-semibold cursor-default">
                ...
                <div className="flex items-center ml-36">
                  <div className="w-1/2 flex items-center justify-start gap-3">
                    <div className="text-right text-[12px] font-[500]">
                      {calculateDuration(task.expected_start_date, task.target_date).isOverdue
                        ? 'Overdued Time:'
                        : 'Time Left:'}
                    </div>
                    <CountdownTimer
          ...
          <div>
            ...
            <div className="border-b-[3px] border-[rgba(190, 190, 190, 1)]"></div>
            <div>
              {tab === 'Subtasks' && !task?.parent_id && (
                <SubtaskTable projectId={task.project_management_id} />
              )}
              ...
              {tab === 'Project Drive' && <>Project Drive</>}
