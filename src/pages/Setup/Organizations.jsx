...
import { fetchOrganizations, editOrganization } from '../../redux/slices/organizationSlice';
          ...
          return url ? (
            <a href={url} target="_blank" rel="noopener noreferrer" className="flex justify-center">
              <img
                src={url}
                alt="Logo"
                className="w-14 h-14 object-cover rounded border hover:scale-110 transition-transform"
              />
            </a>
          ) : (
