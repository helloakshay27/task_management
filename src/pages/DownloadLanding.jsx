...
const DownloadLanding = () => {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            {/* Header - Simplified version of Navbar */}
            <header className="w-full bg-white shadow-sm h-[58px] flex items-center px-5 justify-between">
                <Link to="/login">
                    <svg
                        width={173}
                        height={31}
                ...
                <Link to="/login" className="text-sm font-medium text-gray-700 hover:text-red-600">
                    Login
                </Link>
            </header>
                ...
                <div className="max-w-4xl w-full space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Experience the future of project management with our powerful desktop application.
                            Streamline your workflow, collaborate seamlessly, and achieve your goals.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left mt-12">
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Task Tracking</h3>
                            <p className="text-gray-600">Keep track of all your projects and tasks in one place with intelligent insights.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <div className="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-4">
                                <svg className="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-gray-600">Native desktop performance for the smoothest experience on Windows and Mac.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <div className="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-4">
                                <svg className="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-gray-600">Work together with your team in real-time, no matter where you are.</p>
                        </div>
                    </div>
                </div>
            </main>
            ...
            <footer className="bg-white border-t border-gray-200 py-8">
                <div className="max-w-6xl mx-auto px-4 text-center text-gray-500 text-sm">
                    &copy; {new Date().getFullYear()} Lockated. All rights reserved.
                </div>
            </footer>
        </div>
    );
