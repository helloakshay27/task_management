...
export const fetchInternalUserDetails = createAsyncThunk(
...
export const fetchUpdateUser = createAsyncThunk(
  ...
  async ({ token, userId, updatedData }, { rejectWithValue }) => {
    try {
      const response = await axios.put(`${baseURL}/users/${userId}.json`, updatedData, {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const fetchInternalUserDetailsSlice = createApiSlice(
  'fetchInternalUserDetails',
  fetchInternalUserDetails
);
export const removeUserFromProjectSlice = createApiSlice(
  'removeUserFromProject',
  removeUserFromProject
);
export const fetchAssociatedProjectsSlice = createApiSlice(
  'fetchAssociatedProjects',
  fetchAssociatedProjects
);
export const reassignProjectsSlice = createApiSlice('reassignProjects', reassignProjects);
export const fetchUserAvailabilitySlice = createApiSlice(
  'fetchUserAvailability',
  fetchUserAvailability
);
