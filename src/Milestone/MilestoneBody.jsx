      ...
      if (btn) {
        ...
        if (taskId) {
          const entityDisplayName =
            itemType === 'milestone' ? 'Milestone' : itemType === 'task' ? 'Task' : 'Subtask';
    ...
    const allColumnsConfig = [
      ...
      },
      {
        ...
        template: function (task) {
          if (task.type === 'milestone') {
            return `<span style="cursor: pointer; font-size: 14px;" title="${
              task.text
      ...
      },
      {
        ...
        template: function (task) {
          console.log(task);
          if (task.type === 'milestone') {
            return `<span class="gantt-milestone-link" data-id="${
              task.navigationid
          ...
          return `<span class="gantt-subtask-link" data-id="${
            task.navigationid
