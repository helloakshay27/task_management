    ...
    <div className="m-4">
      <div className="px-4 pt-1">
        ...
        <div className="border rounded-md shadow-[0_4px_6px_rgba(0,0,0,0.1)] p-5 mb-4">
          ...
          <div
            className={`mt-3 ${isSecondCollapsed ? 'h-0 overflow-hidden' : ''}`}
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center ml-36">
                <div className="w-1/2 flex items-center justify-start gap-3">
                  ...
                  <div className="text-left text-[12px]">{newSprint.priority}</div>
                </div>
              </div>
              <span className="border h-[1px] inline-block w-full my-4"></span>
              <div className="flex items-center ml-36">
        ...
        <div>
          ...
          <div>{tab == 'Tasks' && <SprintTasksTable sprint={newSprint} />}</div>
        </div>
      </div>
    </div>
  );
