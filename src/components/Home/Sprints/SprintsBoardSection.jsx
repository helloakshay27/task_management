...
import { CalendarDays, Circle, CircleCheck, GripHorizontal, Play, Square, Timer, User, X } from "lucide-react"
...
const SprintsBoardSection = ({ selectedProject }) => {
    ...
    return (
        <div className="relative">
            {isModalOpen && <ConfirmationModal handleCancel={handleCancel} handleConfirmStart={handleConfirmStart} />}
            <div
            ...
            >
              ...
              ${isOver && canDrop && selectedSprint?.status === "stopped"
                ...
                {sprintTitle.map((card) => {
                    const sprintTaskIds =
                        sprint?.sprint_tasks?.map((sprintTask) => sprintTask.task_id) ||
                        [];
