    ...
    const fetchTaskSuggestions = async (searchTerm) => {
        ...
        try {
            ...
            const response = await axios.get(
                `${baseURL}/task_managements.json?${params.toString()}`,
                {
                    headers: {
            ...
            const tasks = Array.isArray(response.data.task_managements) ? response.data.task_managements : [];
