                    ...
                    if (Array.isArray(item.sprint_tasks)) {
                        item.sprint_tasks.forEach((task) => {
                            ...
                            tasksData.push({
                                ...
                                owner: task.task_management?.responsible_person ? task.task_management.responsible_person.name : "",
                                parent: sprintId,
                                type: "task",
                            });
