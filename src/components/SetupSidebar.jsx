          ...
          <ul className="flex flex-col">
            <li
              className={`sidebar-link cursor-pointer ${!isSidebarOpen ? 'justify-center' : ''} ${
                isUsersSubMenuOpen ? 'bg-[#c72030] text-white' : ''
              }`}
            ...
            {isSidebarOpen && isUsersSubMenuOpen && (
              <>
                <li className="text-[14px] ms-[60px] mb-4 mt-2">
                  <NavLink
                    to="/setup/roles"
                    className={({ isActive }) => `${isActive ? 'text-[#c72030]' : 'text-gray-700'}`}
                  >
                    Roles
                  </NavLink>
                </li>
            ...
            <li
              className={`sidebar-link cursor-pointer ${!isSidebarOpen ? 'justify-center' : ''} ${
                isProjectSubMenuOpen ? 'bg-[#c72030] text-white' : ''
              }`}
            ...
            <li
              className={`sidebar-link cursor-pointer ${!isSidebarOpen ? 'justify-center' : ''} ${
                isIssuesSubMenuOpen ? 'bg-[#c72030] text-white' : ''
              }`}
